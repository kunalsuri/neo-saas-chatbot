...
# Feature Catalog — neo-saas-chatbot Master Index
...
>
> **Cold-start snapshot — 2026-06-28** (commit `<commit-hash>`), once generated.
>
...
Depending on the complexity of neo-saas-chatbot, the catalog can live in a single file or be split to reduce token context overhead:
