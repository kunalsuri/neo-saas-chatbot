/**
 * Copyright 2026 Kunal Suri — Licensed under the Apache License 2.0 (see LICENSE file)
 * 
 * Standalone SVG Brand Icons previously bundled in Lucide v0.x.
 * Lucide v1.x removed brand icons for design and trademark policy.
 */
