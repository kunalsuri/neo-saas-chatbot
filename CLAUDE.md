...
# neo-saas-chatbot — Claude Code project memory
...
- Test:  `npm test` (runs all tests), `npm run test:extended` (runs backend tests)
- Test locations: `client/src/**/__tests__/*`, `client/src/**/*.test.ts(x)`, `tests/unit/*.test.ts`, `tests/integration/*.test.ts`
